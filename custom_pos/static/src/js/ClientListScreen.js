odoo.define('custom_pos.ClientListScreen', function(require) {
    ...
    class ClientListScreen extends PosComponent {
        ...
        get clients() {
            console.log('custom_detect delivery_partner button',this.props.hasOwnProperty('delivery_partner_button'));
            if (this.state.query && this.state.query.trim() !== '') {
                if (this.props.hasOwnProperty('delivery_partner_button')) {
                    console.log('custom_detect delivery_partner search');
                    return this.env.pos.db.search_partner(this.state.query.trim(),true);                  

                }
                return this.env.pos.db.search_partner(this.state.query.trim(),false);
            } else {
                if (this.props.hasOwnProperty('delivery_partner_button')) {
                    return this.env.pos.db.get_delivery_partners_sorted(1000);                 
