odoo.define('portal_attendance_pro.GeofenceView', function (require) {
    'use strict';

    var BasicView = require('web.BasicView');
    var GeofenceCommon = require('portal_attendance_pro.GeofenceCommon');
    var core = require('web.core');

    var GeofenceModel = require('portal_attendance_pro.GeofenceModel');
    var GeofenceRenderer = require('portal_attendance_pro.GeofenceRenderer');
    var GeofenceController = require('portal_attendance_pro.GeofenceController');
